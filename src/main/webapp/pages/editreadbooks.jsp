...
<html lang="en">
  ...
  <body>
    ...
    //  get array from localstorage
      let box = JSON.parse(localStorage.getItem("readbooks"));
      // console.log(box);
...
localStorage.setItem("readbooks",JSON.stringify(box))
...
delete_card.addEventListener("click", function (event) {
            ...
            return
              ...
              box.splice(Index, 1);
                console.log(box);
                localStorage.setItem("readbooks", JSON.stringify(box))
                window.location.href = "../pages/readbooks.html";
            }
